...
const Hero = () => {
  return (
    <div className="flex w-full flex-col-reverse lg:flex-row py-6 lg:px-24 px-10 items-center justify-evenly gap-10">
      <div className="flex flex-col justify-center items-center lg:items-start text-center lg:text-start px-16 gap-6">
        <span className="lg:text-7xl text-4xl font-bold  text-gray-900">
